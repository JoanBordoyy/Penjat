...
INSERT INTO TblPaisos VALUES("AQ","Antártida","ATA","Cubre el territorio al sur del paralelo 60° sur.Códigos obtenidos del nombre en francés: Antarctique");
...
INSERT INTO TblPaisos VALUES("DE","Alemania","DEU","Códigos obtenidos del idioma nativo (alemán): DeutschlandCódigos alfa usados por Alemania Occidental antes de la reunificación alemana en 1990.");
...
INSERT INTO TblPaisos VALUES("EH","Sahara Occidental","ESH","Nombre provisional. Anterior nombre en la ISO: Sahara españolCódigos obtenidos del anterior nombre en español");
...
INSERT INTO TblPaisos VALUES("GF","Guayana Francesa","GUF","Departamento de ultramar francés.Códigos obtenidos del nombre en francés: Guyane française");
...
INSERT INTO TblPaisos VALUES("MK","Macedonia del Norte","MKD","Ver: Disputa sobre el nombre de MacedoniaCódigos obtenidos del idioma nativo (macedonio): Makedonija");
...
INSERT INTO TblPaisos VALUES("SX","Sint Maarten (parte neerlandesa)","SXM","Forma parte del Reino de los Países Bajos.Nombre oficial en neerlandés.");
...
INSERT INTO TblPaisos VALUES("TF","Tierras Australes Francesas (las)","ATF","Comprende las tierras australes y antárticas francesas excepto la parte incluida en la Antártida conocida como Tierra Adelia.Códigos obtenidos del nombre en francés: Terres australes françaises.");
...
INSERT INTO TblPaisos VALUES("TW","Taiwán (Provincia de China)","TWN","Cubre la jurisdicción actual de la República de China (Taiwán), excepto Kinmen e Islas Matsu.La ONU considera a Taiwán como una provincia de China, debido a su estatus político.");
